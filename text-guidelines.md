...
* ![APP](./assets/text-guidelines/app-badge.png): Dashboard, Tutorial App, Playground (Home Page is **NOT** included!)
* ![EMAIL](./assets/text-guidelines/email-badge.png): Emails sent by APP
* ![DOCS](./assets/text-guidelines/docs-badge.png): /docs
* ![BLOG](./assets/text-guidelines/blog-badge.png): /blog
* ![GITHUB](./assets/text-guidelines/github-badge.png): GitHub READMEs & documentation comments in code

Some sections of the documentation are marked with these badges to indicate that they apply only to the specified scopes. Unmarked sections apply to all scopes.
...
* **Size** - ![APP](./assets/text-guidelines/app-badge.png)
  * Main titles (page or panel titles): `<h2>`
  * Subsection titles: `<h3>`
* **Size** - ![DOCS](./assets/text-guidelines/docs-badge.png) ![BLOG](./assets/text-guidelines/blog-badge.png) ![GITHUB](./assets/text-guidelines/github-badge.png)
  * Main titles (page titles): `#`
  * Subsection titles: `##`
* **Text casing** - ![APP](./assets/text-guidelines/app-badge.png) ![DOCS](./assets/text-guidelines/docs-badge.png) ![BLOG](./assets/text-guidelines/blog-badge.png) ![GITHUB](./assets/text-guidelines/github-badge.png)

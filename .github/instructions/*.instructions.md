...
* **Adherence to the writing style and text formatting guidelines defined by [ConfigCat's Guidelines for Text](https://github.com/kp-cat/configcat-docs/blob/test/text-guidelines.md)**.
